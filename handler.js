...
module.exports = {
  async handler(chatUpdate) {
    ...
    async function appenTextMessage(text, chatUpdate, conn, m) {
    ...
    try {
      ...
      try {
        ...
        if (settings) {
          ...
          if (!'owners' in settings) settings.owners = ['62857021072505', '6285757657796']
          if (!'link' in settings) settings.link = 'https://whatsapp.com/channel/0029Vac0DjG6xCSJT0HTV61w'
          if (!'cover' in settings) settings.cover = 'https://telegra.ph/file/271c69c776f3af18fc2c2.jpg'
          ...
          rpg: false,
          style: 2,
          owners: ['62857021072505', '6285757657796'],
          link: 'https://whatsapp.com/channel/0029Vac0DjG6xCSJT0HTV61w',
          cover: 'https://telegra.ph/file/271c69c776f3af18fc2c2.jpg'
        }
      } catch (e) {
        console.error(e)
      }
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (!isPrems && plugin.limit && db.data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `ᴍᴀᴀꜰ, ʟɪᴍɪᴛ ᴋᴀᴍᴜ ꜱᴇᴘᴇʀᴛɪɴʏᴀ ꜱᴜᴅᴀʜ ʜᴀʙɪꜱ! ᴍᴏʜᴏɴ ᴍᴇɴᴜɴɢɢᴜ ʜɪɴɢɢᴀ ʟɪᴍɪᴛ ʀᴇꜱᴇᴛ ꜱᴇᴛɪᴀᴘ 24 ᴊᴀᴍ ᴀᴛᴀᴜ ᴜᴘɢʀᴀᴅᴇ ᴋᴇ ʀᴏʟᴇ ᴘʀᴇᴍɪᴜᴍ`, fkontak)
          ...
          if(m.mtype === "interactiveResponseMessage" && m.quoted.fromMe) appenTextMessage(JSON.parse(m.msg.nativeFlowResponseMessage.paramsJson).id, chatUpdate, this, m) 
          if(m.mtype === "templateButtonReplyMessage" && m.quoted.fromMe) appenTextMessage(m.msg.selectedId, chatUpdate, this, m)
          let extra = {
...
`.trim(),
            ...
            try {
              ...
              text = (
                action === "add"
                  ...
                  : chat.sBye || this.bye || global.bye || "Bye, @user!"
  ...
  owner: `─────────────────────\n\`</> O W N E R  </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus Owner\n─────────────────────`,
  mods: `─────────────────────\n\`</> M O D E R A T O R </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus Moderator Bot\n─────────────────────`,
  group: `─────────────────────\n\`</> G R O U P </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus Group Chat\n─────────────────────`,
  banned: `─────────────────────\n\`</> B A N N E D  U S E R </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ hanya User yang di Blokir\n─────────────────────`,
  private: `─────────────────────\n\`</> P R I V A T E </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus Private Chat\n─────────────────────`,
  admin: `─────────────────────\n\`</> A D M I N </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus Admin\n─────────────────────`,
  botAdmin: `─────────────────────\n\`</> B O T  A D M I N </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Jadikan ${namebot} menjadi Admin terlebih dahulu\n─────────────────────`,
  restrict: `─────────────────────\n\`</> R E S T R I C T E D </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ dilarang\n─────────────────────`,
  block: `─────────────────────\n\`</> B L O C K E D </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ sedang di Blokir\n─────────────────────`,
  premium: `─────────────────────\n\`</> P R E M I U M </>\`\n─────────────────────\n┃ Halo @${m.sender.split("@")[0]}\n┃ Command Ini\n┃ khusus User Premium\n─────────────────────`,
    }[type];
    if (msg)
      return conn.sendButton(m.chat,[["View Menu",".menu"],["Owner Bot",".owner"]], m, {
body: msg,
url: thumb, 
})
let msgg = {
...
─────────────────────
┃Halo @${m.sender.split("@")[0]} 
┃Tolong Daftar Terlebih Dahulu
┃Untuk Menggunakan ${namebot}
─────────────────────
        `
    }[type]
    if (msgg)
      return conn.sendButton(m.chat,[["Auto Register","@verify"]], m, {
body: msgg, 
url: thumb, 
})
        });
