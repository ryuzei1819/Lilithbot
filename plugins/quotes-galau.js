...
let handler = async (m, { conn }) => {
  let anu = `https://api.lolhuman.xyz/api/quotemaker2?apikey=${lolkey}&text=${pickRandom(global.galau)}&author=${conn.getName(m.sender)} 

`;
  m.reply(done, anu);
  conn.sendFile(m.chat, 'https://files.catbox.moe/5r438e.opus' , null, null, fkontak);
};
