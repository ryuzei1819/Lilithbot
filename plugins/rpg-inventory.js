...
let handler = async (m, { conn, usedPrefix }) => {
  ...
  let str = `
🧑🏻‍🏫 User: *${await conn.getName(name)}*
❤️ Health: *${health}*
👕 Armor: *${armor == 0 ? "Tidak Punya" : "" || armor == 1 ? "👕 Leather Armor" : "" || armor == 2 ? "⚙️Iron Armor" : "" || armor == 3 ? "🔶 Gold Armor" : "" || armor == 4 ? "💎 Diamond Armor" : "" || armor == 5 ? "🔷 Netherite Armor" : ""}*
💰 Money: *${money}*
🚩 Limit: *${limit}*
💹 Level: *${level}*
✨ Exp: *${exp}*
...
│ ✨ Exp *${exp}* -> *${max}*
│
│🦸‍♂️ Hero ${hero == 0 ? "Tidak Punya" : "" || (hero > 0 && hero < 40) ? `Level *${hero}* To level *${hero + 1}*\n│Exp *${exphero}* -> *${hero * 500}*` : "" || hero == 40 ? "*Max Level*" : ""}
╰────────────────
╭────────────────
...
9. Top Sampah *${userssampah.indexOf(m.sender) + 1}* dari *${userssampah.length}* ♻️
    ...
    m.chat,
    {
      ...
      contextInfo: {
        externalAdReply: {
          title: "[ RPG ] INVENTORY",
          body: "",
          thumbnailUrl: "https://files.catbox.moe/y7q7bb.png",
          sourceUrl: null,
          mediaType: 1,
